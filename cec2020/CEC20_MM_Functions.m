classdef CEC20_MM_Functions
    ...
    methods
        function self = CEC20_MM_Functions()
            self.fun_ids = 1:24;
        end
        function [func_name,n_obj,n_var,xl,xu,repoint,N_ops,fobj] = get_function(self,fun)
            [func_name,n_obj,n_var,xl,xu,repoint,N_ops] = get_info(fun);
            fobj = eval([' @' func_name]);
        end
    end
end
...
%% 获取测试函数信息
function [fname,n_obj,n_var,xl,xu,repoint,N_ops]=get_info(i_func)
switch i_func
    case 1
